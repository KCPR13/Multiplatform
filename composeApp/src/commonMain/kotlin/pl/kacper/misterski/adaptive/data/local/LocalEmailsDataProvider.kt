...
import multiplatform.composeapp.generated.resources.paris_1
import multiplatform.composeapp.generated.resources.paris_2
import multiplatform.composeapp.generated.resources.paris_3
import multiplatform.composeapp.generated.resources.paris_4
import pl.kacper.misterski.adaptive.data.EmailAttachment
import pl.kacper.misterski.adaptive.data.MailboxType
...
object LocalEmailsDataProvider {
    ...
    fun create(): Email {
        return Email(
            Clock.System.now().nanosecondsOfSecond.toLong(), // Unique ID generation.
            LocalAccountsDataProvider.getDefaultUserAccount(),
            createAt = "Just now",
        )
    }
    ...
    fun createReplyTo(replyToId: Long): Email {
        ...
        return Email(
            id = Clock.System.now().nanosecondsOfSecond.toLong(),
